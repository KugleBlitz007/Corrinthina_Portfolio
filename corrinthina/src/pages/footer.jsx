...
<div className="mx-3">
                <a href="https://www.linkedin.com/in/corrinthina/?originalSubdomain=ca" target="_blank" rel="noopener noreferrer">
                    <FaLinkedin className={`text-lg text-white hover:text-blue-500 ${linkClassName}`} />
                </a>
            
</div>
            <div className="mx-3">
                <a href="https://www.instagram.com/corrinthina/" target="_blank" rel="noopener noreferrer">
                    <FaInstagram className={`text-lg text-white hover:text-[#FEDA77] ${linkClassName}`} />
                </a>
            </div>

            <div className="mx-3">
                <a href="https://www.youtube.com/@JohannRajosefa" target="_blank" rel="noopener noreferrer">
                    <FaYoutube className={`text-lg text-white hover:text-red-500 ${linkClassName}`} />
                </a>
            </div>

        </div>

        <div className={` pt-6 text-white text-center mt-6 ${linkClassName}`}>
            <p>© 2025 designed by Corrinthina built by <a href="https://github.com/KugleBlitz007" className={`hover:text-amber-300 ${linkClassName}`}>Johann Rajosefa</a></p>
        </div>
    </footer>
  )
}